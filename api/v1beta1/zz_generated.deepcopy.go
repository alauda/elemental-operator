...
func (in *ObservedStorageDevice) DeepCopyInto(out *ObservedStorageDevice) {
	*out = *in
	if in.Partitions != nil {
		...
		*out = make([]ObservedStoragePartition, len(*in))
		copy(*out, *in)
	}
	if in.IneligibleReasons != nil {
		in, out := &in.IneligibleReasons, &out.IneligibleReasons
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ObservedStoragePartition) DeepCopyInto(out *ObservedStoragePartition) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObservedStoragePartition.
func (in *ObservedStoragePartition) DeepCopy() *ObservedStoragePartition {
	if in == nil {
		return nil
	}
	out := new(ObservedStoragePartition)
	in.DeepCopyInto(out)
	return out
}
